    ...
    <main className={`game-shell ${g.won ? "victory" : ""}`}>
      ...
      <div className="workspace v2">
        ...
        <aside className="shop-panel">
          ...
          <ShopRow name="Iron Drill" detail="+0.8 iron ore/s" icon="⛏" count={g.drills} priceIcon="◆" price={costs.drill} canBuy={g.ore >= costs.drill} onBuy={() => spend("ore", costs.drill, (s) => ({ ...s, drills: s.drills + 1 }))}/>
          <ShopRow name="Copper Drill" detail="+0.65 copper ore/s" icon="⛏" count={g.copperDrills} priceIcon="⚙" price={costs.copperDrill} canBuy={g.gears >= costs.copperDrill} onBuy={() => spend("gears", costs.copperDrill, (s) => ({ ...s, copperDrills: s.copperDrills + 1 }))}/>
          <div className="shop-group">PROCESSING</div>
          <ShopRow name="Iron Furnace" detail="+0.6 iron plate/s" icon="♨" count={g.furnaces} priceIcon="◆" price={costs.furnace} canBuy={g.ore >= costs.furnace} onBuy={() => spend("ore", costs.furnace, (s) => ({ ...s, furnaces: s.furnaces + 1 }))}/>
